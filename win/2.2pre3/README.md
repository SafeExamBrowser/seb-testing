...
This is an internal ETH pre-release version. Please use the testing version of SEB 2.2, which is more recent.
...
- Again changed reload from hard to soft. 
- Updated seb2 browser engine to current state, refactored request handling.
